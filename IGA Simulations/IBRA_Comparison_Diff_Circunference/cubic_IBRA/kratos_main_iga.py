...
plt.figure(figsize=(8, 6))
plt.scatter(x_coords, y_coords, c="blue", s=10, label="Element Centers")
plt.xlabel("X Coordinate")
plt.ylabel("Y Coordinate")
plt.title("Scatter Plot of Element Centers")
plt.legend()
plt.grid(True)

# Save the plot as an image (optional)
plt.savefig("scatter_plot.png", dpi=300, bbox_inches='tight', format='png')
